...
function()
{
	...
	tkgrid(tklabel(frame2,text="Info: Only files with : col1=sample name, col2=RT, mz intensities in all remaining cols"),labh, columnspan=2)
	...
	varnames.cbut <- tkcheckbutton(frame2,text="Columns names on the first row of data file", variable=varnames)
